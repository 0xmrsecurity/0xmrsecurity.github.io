...
> They hide the most dangerous permissions! 🎯
...
```bash
For Users:
  aws iam list-user-policies --user-name                       🔶🔶🔶  ← Inline User Policies
  ->  aws iam get-user-policy --user-name <> --policy-name <>
  aws iam list-attached-user-policies --user-name <>           🔷🔷🔷  ← Managed User Policies
  ->  aws iam get-policy --policy-arn <>
  ->  aws iam get-policy-version --policy-arn <> --version-id <v1 to vN>
```
